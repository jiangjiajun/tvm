...
def test_forward_conv_transpose():
    ...
    class Conv2DTranspose1(nn.Layer):
        def __init__(self, stride=1, padding=0, dilation=1):
            ...
            self.conv_transpose = nn.Conv2DTranspose(
                3, 5, 3, stride=stride, padding=padding, dilation=dilation
            )
    ...
    verify_model(Conv2DTranspose1(stride=2, padding="SAME"), conv2d_transpose_input_data)
    verify_model(Conv2DTranspose1(stride=2, padding="VALID"), conv2d_transpose_input_data)
...
def test_forward_pool2d():
    ...
    @paddle.jit.to_static
    def pool2d3(inputs):
        output = nn.functional.max_pool2d(inputs, kernel_size=2, stride=2, padding="SAME")
        return output
